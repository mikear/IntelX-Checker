...
def generate_html_report(records: List[Dict[str, Any]], output_filepath: str, search_term: str, app_version: str = "2.0.0") -> str:
    ...
    add("table{width:100%;border-collapse:collapse;margin-top:6px;font-size:.8rem;background:#1e293b;color:#f1f5f9;}")
    add("th,td{padding:6px 8px;border-bottom:1px solid #334155;text-align:left;color:#f1f5f9;}")
    add("th{background:#4F46E5;color:#fff;font-weight:600;font-size:.7rem;letter-spacing:.5px;}")
    add("tbody tr:nth-child(even){background:#253247;}")
    add("tbody tr:hover{background:#334155;}")
